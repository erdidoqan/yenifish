...
switch( $_REQUEST['font'] ){
		...
		default:
			echo "<link rel='stylesheet' id='functions-css'  href='//fonts.googleapis.com/css?family=".$_REQUEST['font'].":400,300italic,100italic,100,300,400italic,500,500italic,700,700italic,900,900italic' type='text/css' media='all' />";
			$font = '"'.$_REQUEST['font'].'"  !important';
		break;
}
?>
