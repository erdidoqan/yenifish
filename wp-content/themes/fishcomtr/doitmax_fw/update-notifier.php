	...
	function update_notifier() {
		...
		if( ini_get('allow_url_fopen') ){
			...
			<div class="wrap">
				...
				<br />
				<?php  } ?>
				<img style="float: left; margin: 0 20px 20px 0; border: 1px solid #ddd;" src="<?php echo get_template_directory_uri() . '/screenshot.png'; ?>" width="320" />
				...
				<div id="instructions">
	  			...
	  			<p><strong>Please note:</strong> before updating the theme make a <strong>backup</strong> of the theme files inside your WordPress installation folder <strong>/wp-content/themes/<?php echo NOTIFIER_THEME_FOLDER_NAME; ?>/</strong></p>
	        <p>&nbsp;</p>
