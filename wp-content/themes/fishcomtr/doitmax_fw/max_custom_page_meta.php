...
include(MAX_FW_PATH.'/page_meta/page.class.php');
include(MAX_FW_PATH.'/page_meta/background.class.php');
include(MAX_FW_PATH.'/page_meta/gallery.class.php');
include(MAX_FW_PATH.'/page_meta/flickr.class.php');
include(MAX_FW_PATH.'/page_meta/flickr.fullsize.class.php');
include(MAX_FW_PATH.'/page_meta/video.fullsize.class.php');
