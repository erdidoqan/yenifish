...
class UIElement_Photo extends UIElement {
	...
	public function getPhotoMetaBox() {
		...
		$this->addGroupOpen(array(
			...
			// Video Url Webm
			$this->addInput(array(
				"id" => MAX_SHORTNAME."_video_url_webm_value",
				"label" => __('Webm File URL (required)', MAX_SHORTNAME),
				"size" => 640,
				"display" => true,
				"desc" => __('The URL of your self hosted Webmvideo file ( .webm ). This file is required to make your video run in all browsers!', MAX_SHORTNAME),
				"standard" => "",
			));
		...
		// // Photo item type
		// $this->addDropdown(array(
		// 	'id' 		=> MAX_SHORTNAME."_photo_detail_type",
		// 	'label' 	=> __('Choose photo project details source', MAX_SHORTNAME),
		// 	'options'   => array('featured' => __('Featured image', MAX_SHORTNAME),
		// 	                     'gallery'  => __('Attached gallery', MAX_SHORTNAM)
		// 					),
		// 	'standard'  => "featured",
		// 	'desc'	    => __('Shall a featured image or a gallery be shown on this photo post? The fatured image is showing on a detail page with some text. For the gallery you can choose different display types and all images from the attached galleries are showing on this page.')
		// ));

		// // Group for default single detail page
		// $this->addGroupOpen(array(
		// 	"id" => MAX_SHORTNAME.'_photo_group_gallery',
		// 	'dependency' => MAX_SHORTNAME.'_photo_detail_type::gallery',
		// 	"display" => false
		// ));

		// 	// Group for default single detail page
		// 	$this->addGallery(array(
		// 		'id' 	 => MAX_SHORTNAME.'_photo_details_gallery',
		// 		'desc'   => __('Click "Add Gallery" or "Edit Gallery" to add or edit your gallery for this post.', MAX_SHORTNAME),
		// 		'label'  => __('Add gallery to post')
		// 	));

		// $this->addGroupClose(array(
		// 	"id" => MAX_SHORTNAME.'_photo_detail_type_close',
		// ));
		...
		$this->addGroupOpen(array(
			...
			$this->addDropdown(array(
				...
				"label" => __('Type of lightbox media', MAX_SHORTNAME),
			...
			$this->addInput(array(
				...
				"label" => __('YouTube URL to show in the lightbox', MAX_SHORTNAME),
				"size" => 640,
				"standard" => "",
				"display" => false,
			...
			$this->addInput(array(
				...
				"label" => __('Vimeo URL to show in the lightbox', MAX_SHORTNAME),
				"size" => 640,
				"standard" => "",
				"display" => false,
			...
			$this->addInput(array(
				...
				"label" => __('Custom URL to show in the lightbox', MAX_SHORTNAME),
				"size" => "640",
		...
		$this->addDropdown(array(
			...
			"label" => __('Thumbnail cropping direction', MAX_SHORTNAME),
