	...
	public function getMetaBox() {
		...
		$this->addGroupOpen(array(
			...
			$this->addDropdown(array(
				...
				"standard" => "none",
				"display" => true,
				"desc" => __('Choose wether to show a slider or stacked images instead of the featured image.', MAX_SHORTNAME )
			));
			...
			$this->addUploadImage(array(
				...
				'label' => __('Add Images', MAX_SHORTNAME),
				'media_label' => __('Use this Image as Featured Image', MAX_SHORTNAME),
				'button' => __('Browse', MAX_SHORTNAME),
				'standard' => '',
				"display" => false,
				'dependency' => MAX_SHORTNAME.'_photo_slider_select::{not}none',
				"desc" => 'These pictures are displayed photo post details in addition to the post featured image. The featured image is always displayed first.'
			));
