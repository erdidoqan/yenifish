...
include(MAX_FW_PATH."/widgets/widget-terms.php");
// Add the Recent Photos Widget
include(MAX_FW_PATH."/widgets/widget-recent-photos.php");
// Add the Recent Tweets Widget
include(MAX_FW_PATH."/widgets/widget-twitter.php");
// Add the Flickr Stream Widget
include(MAX_FW_PATH."/widgets/widget-flickr.php");
// Add the Custom Video Widget
include(MAX_FW_PATH."/widgets/widget-video.php");
// Add the Custom Welcome Teaser Widget
include(MAX_FW_PATH."/widgets/widget-teaser.php");
