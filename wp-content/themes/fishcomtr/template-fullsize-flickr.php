...
$sidebar_string = max_get_custom_sidebar('sidebar-fullsize-flickr'); /* get the custom or default sidebar name */
...
<div id="controls-wrapper">
	...
	<div id="controls" <?php if ( get_option_max('flickr_thumbnail_navigation') == 'true' ){ ?>class="has_thumbs"<?php }?>>
		...
		<?php if( get_option_max('flickr_slide_counter') == "true" ){ ?>
		<!--Slide counter-->
		<div id="slidecounter">
...
<script type="text/javascript">
	...
	jQuery(function($){
		...
		jQuery.supersized({
				...
				slide_interval	  		: <?php echo get_option_max('flickr_slideshow_interval') ?>,	//Length between transitions
				transition        		: <?php echo get_option_max('flickr_transition') ?>, 		//0-None, 1-Fade, 2-Slide Top, 3-Slide Right, 4-Slide Bottom, 5-Slide Left
				transition_speed		: <?php echo get_option_max('flickr_transition_speed') ?>,	//Speed of transition

				//Size & Position
				fit_portrait			: <?php $fit_always = get_option_max('flickr_always_fit') == 'true' ? '1' : '0'; echo $fit_always; ?>, //Image will never exceed browser width or height (Ignores min. dimensions)
				fit_landscape			: <?php $fit_always = get_option_max('flickr_always_fit') == 'true' ? '1' : '0'; echo $fit_always; ?>, //Image will never exceed browser width or height (Ignores min. dimensions)
