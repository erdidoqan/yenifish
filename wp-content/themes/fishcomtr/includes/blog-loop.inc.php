...
?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>>
					...
					<div class="rel">
						...
						if( isset($post_meta[MAX_SHORTNAME.'_photo_slider_select']) && $post_meta[MAX_SHORTNAME.'_photo_slider_select'] != "" && $post_meta[MAX_SHORTNAME.'_photo_slider_select'] != "none" && $post_meta[MAX_SHORTNAME.'_photo_item_type_value'] == "none" && $show_compact == 'false' ){
							  ...
							  // strip of "slider-"
							$slider_tpl = preg_split("/-/", $post_meta[MAX_SHORTNAME.'_photo_slider_select']);
							get_template_part( 'includes/slider', $slider_tpl[1].'.inc' );

							/*-----------------------------------------------------------------------------------*/
							/*  Get Kwicks JS if needed
							/*-----------------------------------------------------------------------------------*/
							if( $post_meta[MAX_SHORTNAME.'_photo_slider_select'] == 'slider-kwicks'){ ?>
								<script src="<?php echo get_template_directory_uri() ?>/slider/kwicks/jquery.kwicks.min.js"></script>
								<script src="<?php echo get_template_directory_uri() ?>/slider/flexslider/jquery.flexslider.min.js"></script>
								<link rel="stylesheet" type="text/css" media="all" href="<?php echo get_template_directory_uri() ?>/slider/flexslider/flexslider.css" />
								<link rel="stylesheet" type="text/css" media="all" href="<?php echo get_template_directory_uri() ?>/slider/kwicks/kwicks-slider.css" />
							<?php
							}
          ...
          <?php if ( !post_password_required() && get_option_max('general_show_fullblog') == 'true' ) : // including the template social-share.inc.php and the tags ?>
					<div class="clearfix">

						<?php get_template_part( 'includes/social', 'share.inc' ); ?>
